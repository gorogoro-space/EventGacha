 ...
 */
public class EventGachaUtility {
  ...
  public static boolean isInPunch(Player player){
    if( player.hasMetadata(EventGachaCommand.META_CHEST)){
      return true;
    }
    return false;
  }
  ...
  public static String getGachaNameInPunch(Player player){
    for(MetadataValue mv:player.getMetadata(EventGachaCommand.META_CHEST)) {
      return mv.asString();
    }
    return null;
  }
   ...
   */
  public static void setPunch(Player player, EventGacha gacha, String gachaName){
    removePunch(player, gacha);
    player.setMetadata(EventGachaCommand.META_CHEST, new FixedMetadataValue(gacha, gachaName));
  }
   ...
   * @param EventGacha Gacha
   */
  public static void removePunch(Player player, EventGacha gacha){
    player.removeMetadata(EventGachaCommand.META_CHEST, gacha);
  }
  ...
  public static void sendMessage(CommandSender sender, String message){
    sender.sendMessage((Object)ChatColor.DARK_RED + "[EventGacha]" + " " + (Object)ChatColor.RED + message);
  }
